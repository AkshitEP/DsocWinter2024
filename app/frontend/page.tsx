...
const allParticipants = [
  { id: 1, name: "Aliceyy Johnson", points: 120, categories: ["AppDev", "Frontend"] },
...
export default function Frontend() {
  const frontendParticipants = allParticipants.filter(participant => 
    participant.categories.includes("Frontend")
  )
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
      ...
      <main className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
        <div className="px-4 py-6 sm:px-0">
          <h1 className="text-4xl font-bold text-center text-blue-800 mb-8">Frontend Leaderboard</h1>
          <div className="bg-white p-6 rounded-3xl shadow-lg">
            <Leaderboard title="Frontend Leaderboard" participants={frontendParticipants} />
          </div>
        </div>
      </main>
    </div>
